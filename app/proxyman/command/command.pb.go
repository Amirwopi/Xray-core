...
type KillUserConnectionsRequest struct {
	state                protoimpl.MessageState `protogen:"open.v1"`
	Email                string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	InboundTag           string                 `protobuf:"bytes,2,opt,name=inbound_tag,json=inboundTag,proto3" json:"inbound_tag,omitempty"`
	Reason               string                 `protobuf:"bytes,3,opt,name=reason,proto3" json:"reason,omitempty"`
	IncludeScopedAliases bool                   `protobuf:"varint,4,opt,name=include_scoped_aliases,json=includeScopedAliases,proto3" json:"include_scoped_aliases,omitempty"`
	AllInbounds          bool                   `protobuf:"varint,5,opt,name=all_inbounds,json=allInbounds,proto3" json:"all_inbounds,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *KillUserConnectionsRequest) Reset() {
	*x = KillUserConnectionsRequest{}
	mi := &file_app_proxyman_command_command_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KillUserConnectionsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KillUserConnectionsRequest) ProtoMessage() {}

func (x *KillUserConnectionsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_proxyman_command_command_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KillUserConnectionsRequest.ProtoReflect.Descriptor instead.
func (*KillUserConnectionsRequest) Descriptor() ([]byte, []int) {
	return file_app_proxyman_command_command_proto_rawDescGZIP(), []int{13}
}

func (x *KillUserConnectionsRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *KillUserConnectionsRequest) GetInboundTag() string {
	if x != nil {
		return x.InboundTag
	}
	return ""
...
func (x *KillUserConnectionsRequest) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *KillUserConnectionsRequest) GetIncludeScopedAliases() bool {
	if x != nil {
		return x.IncludeScopedAliases
	}
	return false
}

func (x *KillUserConnectionsRequest) GetAllInbounds() bool {
	if x != nil {
		return x.AllInbounds
	}
	return false
}

type KillUserConnectionsResponse struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	KilledCount       int64                  `protobuf:"varint,1,opt,name=killed_count,json=killedCount,proto3" json:"killed_count,omitempty"`
	MatchedIdentities []string               `protobuf:"bytes,2,rep,name=matched_identities,json=matchedIdentities,proto3" json:"matched_identities,omitempty"`
	Success           bool                   `protobuf:"varint,3,opt,name=success,proto3" json:"success,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *KillUserConnectionsResponse) Reset() {
	*x = KillUserConnectionsResponse{}
	mi := &file_app_proxyman_command_command_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KillUserConnectionsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KillUserConnectionsResponse) ProtoMessage() {}

func (x *KillUserConnectionsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_proxyman_command_command_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KillUserConnectionsResponse.ProtoReflect.Descriptor instead.
func (*KillUserConnectionsResponse) Descriptor() ([]byte, []int) {
	return file_app_proxyman_command_command_proto_rawDescGZIP(), []int{14}
}

func (x *KillUserConnectionsResponse) GetKilledCount() int64 {
	if x != nil {
...
func (x *KillUserConnectionsResponse) GetMatchedIdentities() []string {
	if x != nil {
		return x.MatchedIdentities
	}
	return nil
}

func (x *KillUserConnectionsResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_app_proxyman_command_command_proto_rawDesc = "" +
	...
	"\x05count\x18\x01 \x01(\x03R\x05count\"\xc4\x01\n" +
	"\x1aKillUserConnectionsRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1f\n" +
	"\vinbound_tag\x18\x02 \x01(\tR\n" +
	"inboundTag\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x124\n" +
	"\x16include_scoped_aliases\x18\x04 \x01(\bR\x14includeScopedAliases\x12!\n" +
	"\fall_inbounds\x18\x05 \x01(\bR\vallInbounds\"\x89\x01\n" +
	"\x1bKillUserConnectionsResponse\x12!\n" +
	"\fkilled_count\x18\x01 \x01(\x03R\vkilledCount\x12-\n" +
	"\x12matched_identities\x18\x02 \x03(\tR\x11matchedIdentities\x12\x18\n" +
	...
	"\x14GetInboundUsersCount\x120.xray.app.proxyman.command.GetInboundUserRequest\x1a7.xray.app.proxyman.command.GetInboundUsersCountResponse\"\x00\x12\x86\x01\n" +
	"\x13KillUserConnections\x125.xray.app.proxyman.command.KillUserConnectionsRequest\x1a6.xray.app.proxyman.command.KillUserConnectionsResponse\"\x00\x12n\n" +
...
var file_app_proxyman_command_command_proto_goTypes = []any{
	...
	(*KillUserConnectionsRequest)(nil),   // 13: xray.app.proxyman.command.KillUserConnectionsRequest
	(*KillUserConnectionsResponse)(nil),  // 14: xray.app.proxyman.command.KillUserConnectionsResponse
...
var file_app_proxyman_command_command_proto_depIdxs = []int32{
	...
	27, // 5: xray.app.proxyman.command.AddOutboundRequest.outbound:type_name -> xray.core.OutboundHandlerConfig
	26, // 6: xray.app.proxyman.command.AlterOutboundRequest.operation:type_name -> xray.common.serial.TypedMessage
	27, // 7: xray.app.proxyman.command.ListOutboundsResponse.outbounds:type_name -> xray.core.OutboundHandlerConfig
	...
	13, // 14: xray.app.proxyman.command.HandlerService.KillUserConnections:input_type -> xray.app.proxyman.command.KillUserConnectionsRequest
	15, // 15: xray.app.proxyman.command.HandlerService.AddOutbound:input_type -> xray.app.proxyman.command.AddOutboundRequest
	17, // 16: xray.app.proxyman.command.HandlerService.RemoveOutbound:input_type -> xray.app.proxyman.command.RemoveOutboundRequest
	19, // 17: xray.app.proxyman.command.HandlerService.AlterOutbound:input_type -> xray.app.proxyman.command.AlterOutboundRequest
	21, // 18: xray.app.proxyman.command.HandlerService.ListOutbounds:input_type -> xray.app.proxyman.command.ListOutboundsRequest
	3,  // 19: xray.app.proxyman.command.HandlerService.AddInbound:output_type -> xray.app.proxyman.command.AddInboundResponse
	5,  // 20: xray.app.proxyman.command.HandlerService.RemoveInbound:output_type -> xray.app.proxyman.command.RemoveInboundResponse
	7,  // 21: xray.app.proxyman.command.HandlerService.AlterInbound:output_type -> xray.app.proxyman.command.AlterInboundResponse
	9,  // 22: xray.app.proxyman.command.HandlerService.ListInbounds:output_type -> xray.app.proxyman.command.ListInboundsResponse
	11, // 23: xray.app.proxyman.command.HandlerService.GetInboundUsers:output_type -> xray.app.proxyman.command.GetInboundUserResponse
	12, // 24: xray.app.proxyman.command.HandlerService.GetInboundUsersCount:output_type -> xray.app.proxyman.command.GetInboundUsersCountResponse
	14, // 25: xray.app.proxyman.command.HandlerService.KillUserConnections:output_type -> xray.app.proxyman.command.KillUserConnectionsResponse
	16, // 26: xray.app.proxyman.command.HandlerService.AddOutbound:output_type -> xray.app.proxyman.command.AddOutboundResponse
	18, // 27: xray.app.proxyman.command.HandlerService.RemoveOutbound:output_type -> xray.app.proxyman.command.RemoveOutboundResponse
	20, // 28: xray.app.proxyman.command.HandlerService.AlterOutbound:output_type -> xray.app.proxyman.command.AlterOutboundResponse
	22, // 29: xray.app.proxyman.command.HandlerService.ListOutbounds:output_type -> xray.app.proxyman.command.ListOutboundsResponse
